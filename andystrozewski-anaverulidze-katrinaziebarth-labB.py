...
def transition(currState, player, move):
    newLocations = copy.copy(currState.pieceLocations)
    if player == "X":
...
def run_test(numRows, numCols, pieces, o_heuristic, x_heuristic, run_number):
    ...
    statsFile.write("White victories: " + str(o_vict) + "\n")
    statsFile.write("Black victories: " + str(x_vict) + "\n")
    statsFile.write("Total games: " + str(run_number) + "\n")
